...
from biblioteca.models import Autor,Empleado,Prestamo,Libro
...
class EmpleadoAdmin(admin.ModelAdmin):
    ...
    search_fields = "emp_nombre", "emp_apellido", "emp_legajo","emp_activo"
...
class PrestamoAdmin(admin.ModelAdmin):
    ...
    list_filter= 'pres_fecha','pres_devolucion','empleado__emp_nombre','empleado__emp_apellido','empleado__emp_legajo'
